...
import edu.brown.cs.student.main.CSVUtilities.FactoryFailureException;
 ...
 * will handle the requests sent by the user. Endpoints: loadcsv: for loading a CSV file onto the
 * server, must provide valid filepath parameter. returns success when loading correctly or an error
 * if it couldn't load it. viewcsv: returns loaded CSV file. Causes error if no CSV file is loaded.
 ...
 * CSV file is loaded. broadband: searches the ACS 2021 data based on two parameters
 */
public class Server {

...
public class BroadbandDataSource implements APIDataSourceInterface {
   ...
   * @throws DatasourceException if the server didn't respond correctly
   * @throws IOException if it wasn't able to open a connection
   */
   ...
   *     data
   */
  private HashMap<String, String> fetchCountyData(String stateId) throws DatasourceException {
   ...
   *     data
   */
  private List<List<String>> fetchBroadbandData(String stateId, String countyId)
